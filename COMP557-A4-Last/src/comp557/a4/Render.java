...
public class Render extends WindowAdapter {
    ...
    /**Flag to indicate whether to use jittering*/
    public boolean jittering;
    
    /**How many samples to take of the light for smooth shadows, if 1 then normal shadowing*/
    public boolean smoothShadows;
    
    /**Size parameter for area lights, only works if smooth shadows are used, larger means larger penumbra*/
    public double lightSize;
    
    /**Levels of reflection to do*/
    public int reflectionLevels;
